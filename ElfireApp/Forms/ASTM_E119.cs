...
{
    public partial class ASTM_E119 : Form
    {
        ...
        public ASTM_E119()
        {
            ...
            this.Load += ASTM_E119_Load;
        }

        private void ASTM_E119_Load(object sender, EventArgs e)
        {
            readyToDraw = true;
            DrawGraph();
        }
        ...
        private void DrawGraph()
        {
            ...
            {
                Times.Add(i);
                double t_minutes = i / 60.0; // Convert time to minutes
