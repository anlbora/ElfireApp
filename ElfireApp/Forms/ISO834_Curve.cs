...
{
    public partial class ISO834_Curve : Form
    {
        ...
        public ISO834_Curve()
        {
            ...
            Shown += ISO834_Curve_Shown; // Use Shown event instead of Load
        ...
        private void ISO834_Curve_Shown(object sender, EventArgs e)
        {
            DrawGraph();  // Draw the graph after the form is shown
        }
        ...
        private void DrawGraph()
        {
            ...
            {
                Times.Add(i);
                Temps.Add(20 + (345 * (Math.Log10(8 * i + 1))));
            }
